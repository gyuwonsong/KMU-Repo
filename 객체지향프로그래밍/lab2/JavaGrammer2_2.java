...
public class JavaGrammer2_2 {
	...
	// (실습2-2) 아래의 조건에 맞게 문장들을 완성한다.
		...
		// (1번문제) 콘솔창에 다음 println()문을 수정하여 오른쪽 문자열 출력:  '안녕'은 'Hello(Hi)'라고 해!
		System.out.println("(1번답) '안녕'은 'Hello(Hi)'라고 해!");
		System.out.println("\n-----------------------------------------------\n");
		...
		System.out.println("송규원 소프트웨어학부 20213015 20 1");
		...
		if(temp == 1)
			...
			freshman = false;
		System.out.println("신입생 여부: " + freshman);
		System.out.println("\n-----------------------------------------------\n");
